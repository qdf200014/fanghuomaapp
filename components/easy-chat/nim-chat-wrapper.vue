<template>
	<view ref="chatWrapper" class="im-flex im-align-start im-content-start im-justify-start" @longpress="longpress">
		<!-- 左箭头 -->
		<image v-if="flow === 'in'" :src="arrowImg" style="width: 40rpx;height: 40rpx;margin-top: 25rpx;" mode="aspectFill"></image>
		<!-- 插入的消息主体 -->
		<view :class="msgWrapperClass" style="max-width: 550rpx;" class="im-flex im-justify-start im-content-start im-align-start"><slot></slot></view>
		<!-- 右箭头 -->
